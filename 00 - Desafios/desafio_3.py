# CONTEXTO: Imagine que você trabalha para uma empresa de telecomunicações e é responsável por validar se um número de telefone fornecido pelo cliente está em um formato correto. 
...
def validate_numero_telefone(phone_number):
    pattern = re.compile('^[(][0-9]{2}[)][ ][9][0-9]{4}[-][0-9]{4}$')
